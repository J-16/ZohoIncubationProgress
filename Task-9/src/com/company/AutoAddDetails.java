...
public class AutoAddDetails {

    {
        ...
        ProductController productController = new ProductController( (Company) new AuthenticationController().login("company1@gmail.com", "123456789",CompanyDatabase.UserType.COMPANY) );
        ...
        productController = new ProductController( (Company) new AuthenticationController().login("company1@gmail.com", "123456789",CompanyDatabase.UserType.COMPANY));
